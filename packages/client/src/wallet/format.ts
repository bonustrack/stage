...
/** Format a decimal-string token balance for display. Tighter precision for big
 *  numbers; more for dust — keeps the row clean without dropping informative
 *  digits on, say, 0.0034 ETH. */
