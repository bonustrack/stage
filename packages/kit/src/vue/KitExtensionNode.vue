...
<template>
  ...
  <TextField
    ...
    :font-family="textFieldNode.fontFamily ?? resolveWeight(textFieldNode.fontWeight)"
    ...
    :no-focus-border="textFieldNode.noFocusBorder"
    ...
    :input-mode="textFieldNode.inputMode"
  ...
  <AvatarStack
    ...
    :ring="resolveOptionalColor(avatarNode.ring, scheme)"
    :fallback-background="resolveOptionalColor(avatarNode.fallbackBackground, scheme)"
