...
export const HERO_ICON_PATHS = {
  ...
  // chatRect — squared-off speech bubble (rounded-rect body + bottom-left tail)
  chatRect: 'M8 11h.01M12 11h.01M16 11h.01M5 4h14a2 2 0 012 2v8a2 2 0 01-2 2H9l-4 4v-4a2 2 0 01-2-2V6a2 2 0 012-2z',
