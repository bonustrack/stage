...
export const HERO_ICON_PATHS = {
  ...
  // chatBubble — heroicons v1 chat-alt rectangular speech bubble WITHOUT the three dots
  chatBubble: 'M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z',
