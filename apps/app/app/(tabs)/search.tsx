 ...
 *  horizontal pager in `_layout.tsx` (all five tab bodies mounted side-by-side
 *  so swiping reveals the neighbour as it follows the finger). This file exists
 *  only so expo-router keeps a real route per tab — deep links to `/search`
 *  resolve, the URL stays correct, and the bottom tab-bar highlight is
