    ...
    return (
      <Box style={{ flex: 1, backgroundColor: bg }}>
        ...
        <Col mx={16} py={40} align="center">
          <Text size="md" style={{ color: sub, fontFamily: 'Calibre-Medium' }}>Token not found</Text>
        </Col>
      </Box>
    );
  }
    ...
    <Box style={{ flex: 1, backgroundColor: bg }}>
      ...
      <Col mx={16} pt={28} align="start" gap={6}>
        ...
        <Row align="center" gap={6} mt={10}>
          ...
          <Text size="xxl" style={{ color: head, fontFamily: 'Calibre-Semibold' }}>{r.name}</Text>
        </Row>
        ...
        <Text size="xxxl" style={{ color: head, fontFamily: 'Calibre-Semibold', marginTop: 14 }}>
