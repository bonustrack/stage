    ...
    return (
      <Box style={{ flex: 1, backgroundColor: bg }}>
        ...
        <Col mx={16} py={40} align="center">
          <Text style={{ color: sub, fontSize: fontSize('md'), fontFamily: 'Calibre-Medium' }}>Token not found</Text>
        </Col>
      </Box>
    );
  }
    ...
    <Box style={{ flex: 1, backgroundColor: bg }}>
      ...
      <Col mx={16} pt={28} align="start" gap={6}>
        ...
        <Row align="center" gap={6} mt={10}>
          ...
          <Text style={{ color: head, fontSize: fontSize('xxl'), fontFamily: 'Calibre-Semibold' }}>{r.name}</Text>
        </Row>
        ...
        <Text style={{ color: head, fontSize: fontSize('xxxl'), fontFamily: 'Calibre-Semibold', marginTop: 14 }}>
