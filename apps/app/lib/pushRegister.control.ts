/** Control-DM wire format shared with the daemon train.
 *
 *  Extracted from pushRegister.ts (mechanical split, behavior identical). See
 *  pushRegister.ts header for the full CONTROL-DM WIRE FORMAT contract. */
