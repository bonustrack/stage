/**
 * @file XMTP remote-attachment send / resolve helpers for the app's XMTP client lib (extracted from lib/xmtp.ts, re-exported there).
 *  Swarm gateway plumbing + file materialisation live in xmtp.swarm.ts; all encryption/upload behavior is kept byte-identical.
 */
