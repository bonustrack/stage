...
/** The exact subset of the SDK surface lib/railgun uses, typed from the real
 *  module so signatures stay honest without a runtime import. */
...
/** Get the SDK or throw a friendly error — for code paths already gated on
 *  availability that genuinely need it. */
