/** @file Railgun engine lifecycle + eager background pre-warm (engine init, prover load, artifact download) so 'send' incurs no cold-start latency; no-ops when the native prover is unlinked. */
/**
