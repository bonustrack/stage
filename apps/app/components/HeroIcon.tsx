/** Heroicons v1 — outline + solid. Only the paths the app actually uses, hand-pasted from
 * tailwindlabs/heroicons@v1 to keep zero runtime deps. viewBox is 24×24, stroke is currentColor.
 *
 * To add: copy the `<path …/>` `d=` value from https://github.com/tailwindlabs/heroicons/tree/v1
 * and drop it into OUTLINE / SOLID below.
 */
...
export function HeroIcon({ name, size = 24, color = 'currentColor', filled = false }: Props): React.ReactElement {
  const set = filled ? SOLID : OUTLINE;
  // Solid is filled; outline is stroked. Solid uses a 0..20 viewBox, outline uses 0..24.
