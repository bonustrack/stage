  ...
  return (
    <SheetModal visible={visible} onClose={onClose} bg={p.sheetBg} border={p.border}>
      <Input
        ...
        style={{
          color: p.head, fontFamily: 'Menlo', fontSize: fontSize('sm'),
          borderWidth: 1, borderColor: p.border, borderRadius: 10,
          paddingHorizontal: 12, paddingVertical: 10, marginBottom: 8, minHeight: 0,
        }}
      />
      {importErr ? <Text style={{ color: DANGER, fontSize: fontSize('sm'), marginBottom: 8, fontFamily: 'Calibre-Medium' }}>{importErr}</Text> : null}
...
export function ExportSheet({ revealPk, onClose, dark, p }: {
  ...
  return (
    <SheetModal visible={revealPk !== null} onClose={onClose} bg={p.sheetBg} border={p.border}>
      <Text style={{ color: DANGER, fontSize: fontSize('sm'), fontFamily: 'Calibre-Medium', marginBottom: 8 }}>
        Anyone with this key controls the account. Never share it.
      </Text>
      <Text selectable style={{
        color: p.head, fontFamily: 'Menlo', fontSize: fontSize('sm'), lineHeight: 18,
        borderWidth: 1, borderColor: p.border, borderRadius: 10,
