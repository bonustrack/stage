...
/** Shape covers both messenger-station attachments (with id+url) and XMTP inline attachments
 *  (with dataB64 instead). Renderer picks the right source for each kind. */
