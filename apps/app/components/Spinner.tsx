/** @file Animated circular loading spinner (a rotating gradient-stroked comet) mirroring @snapshot-labs/tune's UiLoading so the app matches the web. */
      ...
      <Svg width={size} height={size} viewBox="0 0 24 24">
        <Defs>
          <LinearGradient id={gid} x1="28.154%" y1="63.74%" x2="74.629%" y2="17.783%">
            ...
            {/** Cut the tail off abruptly instead of a long soft fade, which read as a "rounded" end. */}
        ...
        <G transform="translate(2)" fill="none" fillRule="evenodd">
          ...
          {/** Solid square cap over the leading stroke end (width 4 == strokeWidth) so it fully covers the butt end with a hard, straight edge. */}
