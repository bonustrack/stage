 ...
 *   - source animation -> per sampled frame -> downsample onto a 58x78 grid
 ...
 *     DISTINCT x/y factors (12x16 px per cell) so the cells are hard-edged
 *     RECTANGLES (taller than wide), giving a 696x1248 frame that matches the
 ...
 *  frames always fill the screen regardless of their 696x1248 aspect. */
