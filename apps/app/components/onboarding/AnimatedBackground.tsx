 ...
 *   - source animation -> per sampled frame -> downsample onto an 88x79 grid
 ...
 *     DISTINCT x/y factors (8x16 px per cell) so the cells are hard-edged
 *     RECTANGLES (taller than wide), giving a 704x1264 frame that matches the
