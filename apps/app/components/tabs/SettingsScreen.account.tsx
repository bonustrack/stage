...
export function AccountSecuritySection(
  ...
  return (
    <>
      <Text size="sm" style={{ color: c.sub, paddingHorizontal: 16, paddingTop: 24, paddingBottom: 8, fontFamily: 'Calibre-Medium' }}>
        ACCOUNT
      </Text>
          ...
          <ListView dark={dark}>
            {exportable ? (
              ...
              >
                ...
                <Col flex={1}>
                  <Text size="lg" style={{ color: c.fg, fontFamily: 'Calibre-Medium' }}>
                    {revealed ? 'Tap to copy private key' : 'Export private key'}
                  </Text>
                  {revealed ? (
                    <Text size="sm" selectable style={{ color: c.sub, marginTop: 4, fontFamily: 'Calibre-Medium' }}>
                      {revealed}
                    </Text>
                  ) : null}
                </Col>
            ...
            >
              ...
              <Text size="lg" style={{ color: danger, fontFamily: 'Calibre-Medium', flex: 1 }}>
                Remove account
              </Text>
            </ListViewItem>
          </ListView>
