/** @file HoistedTopnav — the one fixed top bar for the four main tabs, rendered as a sibling above the SwipeTabs pager (swipes/scrolls leave it untouched); always the uniform Home bar, and only Home publishes the shared slot/override. */
