 ...
 *  (@metro-labs/client); this thin adapter injects kit's stampTokenUrl (RN +
 *  web share the same shaping, only the logo-URL helper differs). */

import { fetchAssetRows as sdkFetchAssetRows } from '@metro-labs/client/wallet/balances';
import { type AssetRow } from '@metro-labs/client/wallet/assets';
