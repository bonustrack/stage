/** The real GitHub Octocat mark as an SVG, color-able via `color` to match the
 *  surrounding foreground. Replaces the kit's generic 'code' Heroicon placeholder
 *  used for GitHub links. Path data sourced from snapshot-labs/sx-monorepo
 *  (apps/ui/src/assets/icons/github.svg), viewBox 0 0 1024 1024. */
...
/** GitHub mark. `size` is the square edge in px (default 22); `color` fills the
 *  glyph so it can track the topnav / row foreground color. */
