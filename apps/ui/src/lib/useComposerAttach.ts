/** @file Composable that stages a composer image (paste or file pick) as a pending preview and flushes it as an XMTP attachment on send; pulled out of Composer.vue to keep that file under the per-file LOC cap. */
