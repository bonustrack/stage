...
export function OnboardingCard({ title, banner, footer, children }: {
  title: string; banner?: ReactNode; footer?: ReactNode; children: ReactNode;
}): React.ReactElement {
  ...
  return (
    ...
    >
      ...
      {banner === undefined ? null : (
        <Col background={pal.border} height={BANNER_HEIGHT} align="center" style={{ zIndex: 1 }}>
