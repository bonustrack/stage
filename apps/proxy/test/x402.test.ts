...
test('parses a v1 body challenge (maxAmountRequired)', () => {
...
test('parses a v2-style amount field', () => {
  const c = parseX402Challenge(
...
test('drops options missing scheme/network', () => {
  const c = parseX402Challenge(
...
test('returns null for a non-challenge object', () => {
